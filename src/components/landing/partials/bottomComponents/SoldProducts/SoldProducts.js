  ...
  return(
    <div>
      ...
      <ProductWrapper>
        ...
        <ProductComponent brandName="Abercrombie&Fitch" productDescription="Fierce" details="New in box" details="1.7oz Cologne for men" retailPrice="$58.58" unitPrice="$22.00" quantity="1200pcs" total="$26,400" />
