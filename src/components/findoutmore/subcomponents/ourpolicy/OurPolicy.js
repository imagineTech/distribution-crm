...
const OurPolicy = () => {
  return(
    <OurPolicyContainer>
      <p>Return Policy: Due to the delicate nature of the products we offer, availability inconsistency, and high shipping rates, we only accept returns under the following circumstances.
